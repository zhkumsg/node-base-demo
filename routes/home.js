...
router.get("/", function (req, res, next) {
    ...
    if (!Routebase.IsPermit(req, res, "00001")) { return; }
    switch (req.query["method"]) {
        case "Backend_MenuTree": GetMenuTree(req, res); break;
        case "Backend_BindUserList": BindUserList(req, res); break;
...
function GetMenuTree(req, res) {
    ...
    client.Query(QueryModel.ZK_PERMITINFO, condition, null, 0, 0, false, null).then(m => {
